...
<html lang="es">
    <head>
        <meta charset="UTF-8">
        <title>Trabajos de Titulacion(D)</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="row titulo">   
                ...
                <div class="col-lg-8 col-md-6 col-sm-8 hdr justify-content-center"><h1>Trabajos de Titulacion</h1></div>
                <img class="col-lg-2 col-md-3 col-sm-2 hdr_img" src="img/Logo.png" alt="IPN" class="col-2">
            </div>
            <div class="row fields">
                <div class="row justify-content-center" id="administrador">Trabajos de Titulacion</div>
        ...
        <script src="JS/TrabajosTerminalesDirectores.js"></script>
    </body>
</html>