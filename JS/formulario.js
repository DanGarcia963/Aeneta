window.onload = function () {
    ...
    const validardato = (expresion, target, nombre) => {
        ...
        console.log("Dato:", nombre ,", estado:",campos[nombre] ,"boleta:",campos.boleta, "nombre:", campos.nombre, " apellidoP:", campos.apellidoP," apellidoM:", campos.apellidoM ," curp:", campos.curp ," correo:", campos.correo ," contraseña:", campos.contra);
    };
    ...
    formulario.addEventListener('submit', function(event){
        ...
        if(campos.boleta && campos.nombre && campos.apellidoP && campos.apellidoM && campos.curp && campos.correo && campos.contra){
